...
public class MudarPotenciaMTX1 {
    ...
    private void debugElementosPagina1(WebDriver driver) {
        ...
        new Thread(() -> {
            ...
            for (String valor : VALORES_POTENCIA.keySet()) {
                try {
                    ...
                    Map<String, Object> resultado = configurarPotenciaMTX1(valor);
    ...
    @PostMapping("/testar-sequencia-potencias1")
    public ResponseEntity<Map<String, Object>> testarSequencia1(@RequestParam String sequencia) {
        Map<String, Object> resposta = new HashMap<>();
