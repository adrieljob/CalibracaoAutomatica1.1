...
public class RotinaparaOffsetMtx3 {
    ...
    @PostMapping("/mudar-canal-offset-mtx3")
    public ResponseEntity<Map<String, Object>> mudarCanalOffsetMTX3(@RequestParam String canal) {
    ...
    // ACESSAR MODULADOR
    private void acessarModulator3(WebDriver driver, WebDriverWait wait) throws Exception {
    ...
    // ACESSAR POWERAMP
    private void acessarPowerAmp3(WebDriver driver, WebDriverWait wait) throws Exception {
        WebElement modulator3 = wait.until(ExpectedConditions.elementToBeClickable(
    ...
    // ACESSAR INTERNAL
    private void acessarInternal3(WebDriver driver, WebDriverWait wait) throws Exception {
        WebElement modulator3 = wait.until(ExpectedConditions.elementToBeClickable(
    ...
    private void salvarLog(String canal, String antes, String depois) {
        String filePath = System.getProperty("user.dir") + "/logs_canal_mtx3.txt";
