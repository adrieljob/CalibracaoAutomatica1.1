...
public class MudarPotenciaMTX2 {
    ...
    private void debugElementosPagina2(WebDriver driver) {
        ...
        new Thread(() -> {
            ...
            for (String valor : VALORES_POTENCIA.keySet()) {
                try {
                    ...
                    Map<String, Object> resultado = configurarPotenciaMTX2(valor);
    ...
    @PostMapping("/testar-sequencia-potencias2")
    public ResponseEntity<Map<String, Object>> testarSequencia2(@RequestParam String sequencia) {
        Map<String, Object> resposta = new HashMap<>();
