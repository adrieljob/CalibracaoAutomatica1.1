...
public class AjustarOffSetMtx3 {
    ...
    public ResponseEntity<Map<String, Object>> executarRotinaCompleta() {
        ...
        try {
            ...
            respostaGeral.put("mensagem", "Rotina completa MTX3 executada com sucesso");
            ...
            respostaGeral.put("mensagem", "Erro na rotina completa MTX3: " + e.getMessage());
            respostaGeral.put("hora_inicio", LocalDateTime.now().toString());
            respostaGeral.put("resultados", resultados);

            System.err.println("Erro na rotina completa MTX3: " + e.getMessage());
            e.printStackTrace();
    ...
    private Map<String, Object> processarCanalCompleto(WebDriver driver, WebDriverWait wait, String canal) {
        ...
        try {
            ...
            if (!"sucesso".equals(resultadoAjuste.get("status"))) {
                throw new Exception("Falha no ajuste dinâmico MTX3: " + resultadoAjuste.get("mensagem"));
            }
            ...
            resultado.put("mensagem", "Canal MTX3 " + canal + " processado com sucesso");
            ...
            System.err.println("Erro no processamento do canal MTX3 " + canal + ": " + e.getMessage());
            e.printStackTrace();

            resultado.put("status", "erro");
            resultado.put("mensagem", "Erro no canal MTX3 " + canal + ": " + e.getMessage());
    ...
    private void chamarFuncaoCancelamento(String canal, Map<String, Object> resultadoCanal) {
        try {
            ...
            respostaCancelamento.put("mensagem", "Cancelamento chamado para canal MTX3 " + canal);
            ...
            System.err.println("Erro ao chamar cancelamento para canal MTX3 " + canal + ": " + e.getMessage());
        }
    }
    ...
    // Endpoint para cancelar operação (apenas simbólico) do MTX3
