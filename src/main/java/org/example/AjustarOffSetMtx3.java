...
public class AjustarOffSetMtx3 {
    ...
    private Map<String, Object> processarCanalCompleto(WebDriver driver, WebDriverWait wait, String canal) {
        ...
        try {
            ...
            // 2.1. Desligar o MTX1
            System.out.println(BLUE + "  2.1. Desligando MTX1" + RESET);
            ...
            // 2.4. Ligar o MTX1
            System.out.println(BLUE + "  2.4. Ligando MTX1" + RESET);
            ligarMTX3(driver, wait);

            // 2.5. Esperar 5 minutos
            System.out.println(BLUE + "  2.5. Aguardando 1 minutos para estabilização..." + RESET);
            Thread.sleep(60000);
            ...
            System.out.println(BLUE + "Chamando função de cancelamento" + RESET);
