...
public class AjustarOffSetMtx1 {
    ...
    // Códigos de cores para console (GREEN para MTX4)
    ...
    public ResponseEntity<Map<String, Object>> executarRotinaCompleta() {
        ...
        try {
            System.out.println(GREEN + "=== INICIANDO ROTINA COMPLETA MTX4 ===" + RESET);
            ...
            for (int i = 0; i < canais.length; i++) {
                ...
                System.out.println(GREEN + "PROCESSANDO CANAL MTX4: " + canal + RESET);
    ...
    private Map<String, Object> processarCanalCompleto(WebDriver driver, WebDriverWait wait, String canal) {
        ...
        try {
            ...
            // 2.1. Desligar o MTX4
            System.out.println(GREEN + "  2.1. Desligando MTX4" + RESET);
            ...
            // 2.4. Ligar o MTX4
            System.out.println(GREEN + "  2.4. Ligando MTX4" + RESET);
            ...
            System.out.println(GREEN + "  Canal atual MTX4: " + canalAtual + RESET);
    ...
    private void salvarLogCancelamento(String canal, Map<String, Object> respostaCancelamento) {
        ...
        try (java.io.FileWriter writer = new java.io.FileWriter(filePath, true)) {
            ...
            System.out.println(GREEN + "  Log de cancelamento MTX4 salvo em: " + filePath + RESET);
        } catch (Exception e) {
    ...
    private Map<String, Object> executarAjusteDinamicoPorCanal(WebDriver driver, WebDriverWait wait, String canal) throws Exception {
        ...
        System.out.println(GREEN + "  Offset inicial lido do equipamento MTX4: " + offsetAtual + RESET);
        ...
        switch (canal) {
            case "14":
                ...
                System.out.println(GREEN + "  Parâmetros para canal 14 do MTX4: 70-73 A" + RESET);
                break;
            case "34":
                correnteMinima = 64;
                correnteMaximaErro = 66;
                System.out.println(GREEN + "  Parâmetros para canal 34 do MTX4: 65-68 A" + RESET);
                break;
            case "51":
                correnteMinima = 59;
                correnteMaximaErro = 61;
                System.out.println(GREEN + "  Parâmetros para canal 51 do MTX4: 60-63 A" + RESET);
                break;
            default:
        ...
        while (iteracoes < maxIteracoes) {
            ...
            System.out.println(GREEN + "    Corrente atual MTX4: " + corrente + " A" + RESET);

            // Verificação especial se corrente for zero
            if (corrente == 0) {
                System.out.println(GREEN + "    Corrente = 0 A. Verificando potência e corrente completa do MTX4..." + RESET);
            ...
            if (corrente >= correnteMinima) {
                ...
                if (corrente > correnteMaximaErro) {
                    ...
                    System.out.println(GREEN + "    Aplicando novo offset " + offsetAtual + " no MTX4..." + RESET);
                ...
                System.out.println(GREEN + "    SUCESSO MTX4: Corrente " + corrente + " A dentro dos limites (" +
            ...
            offsetAtual--;
            System.out.println(GREEN + "    Reduzindo offset MTX4 para: " + offsetAtual + RESET);
    ...
    private int lerOffsetAtual(WebDriver driver, WebDriverWait wait) throws Exception {
        try {
            System.out.println(GREEN + "  Lendo offset atual do equipamento MTX4..." + RESET);
            ...
            System.out.println(GREEN + "    Texto do offset atual MTX4: " + textoOffset + RESET);

            double offsetValor = extrairValorNumerico(textoOffset);
            System.out.println(GREEN + "    Offset atual MTX4 extraído: " + (int)offsetValor + RESET);
    ...
    private String mudarCanal(WebDriver driver, WebDriverWait wait, String canal) throws Exception {
        try {
            ...
            System.out.println(GREEN + "  Canal atual MTX4: " + canalAntes + RESET);

            // Se já estiver no canal correto, retornar
            if (canalAntes.equals(canal)) {
                System.out.println(GREEN + "  MTX4 já está no canal " + canal + RESET);
                return canalAntes;
            }
            ...
            System.out.println(GREEN + "  Canal MTX4 configurado: " + canalDepois + RESET);

            int tentativas = 0;
            while (!canalDepois.equals(canal) && tentativas < 3) {
                System.out.println(GREEN + "  Canal MTX4 não mudou corretamente. Tentativa " + (tentativas + 1) + RESET);
                Thread.sleep(1000);
    ...
    private void desligarMTX4(WebDriver driver, WebDriverWait wait) throws Exception {
        ...
        System.out.println(GREEN + "  MTX4 desligado (RfMasterOn = 2)" + RESET);
        Thread.sleep(300);
    }
    ...
    private void ligarMTX4(WebDriver driver, WebDriverWait wait) throws Exception {
        ...
        System.out.println(GREEN + "  MTX4 ligado (RfMasterOn = 1)" + RESET);
        Thread.sleep(300);
    }
    ...
    private void configurarThershold(WebDriver driver, WebDriverWait wait, String valorThershold) throws Exception {
        ...
        System.out.println(GREEN + "  Thershold MTX4 configurado: " + valorThershold + RESET);
        Thread.sleep(300);
    }
    ...
    private void configurarOffset(WebDriver driver, WebDriverWait wait, String valorOffset) throws Exception {
        ...
        System.out.println(GREEN + "  Offset MTX4 configurado: " + valorOffset + RESET);
        Thread.sleep(300);
    }
    ...
    private void configurarPotencia(WebDriver driver, WebDriverWait wait, String potencia) throws Exception {
        ...
        System.out.println(GREEN + "  Potência MTX4 configurada: " + potencia + RESET);
        Thread.sleep(300);
    }
    ...
    private String verificarCorrente(WebDriver driver, WebDriverWait wait) throws Exception {
        ...
        System.out.println(GREEN + "    Texto completo da corrente MTX4: " + textoCompleto + RESET);

        double correnteValor = extrairValorNumerico(textoCompleto);

        System.out.println(GREEN + "    Corrente MTX4 extraída: " + correnteValor + " A" + RESET);
    ...
    private String verificarCanal(WebDriver driver, WebDriverWait wait) throws Exception {
        try {
            ...
            System.out.println(GREEN + "    Texto do elemento canal MTX4: " + canalTexto + RESET);
            ...
            if (canalTexto == null || canalTexto.isEmpty() || canalTexto.contains("Modulator4.Config.UpConverter.ChannelNumber")) {
                ...
                System.out.println(GREEN + "    Value attribute do canal MTX4: " + canalTexto + RESET);
            }

            if (canalTexto == null || canalTexto.isEmpty()) {
                canalTexto = canalElement.getAttribute("innerText");
                System.out.println(GREEN + "    InnerText do canal MTX4: " + canalTexto + RESET);
            }
            ...
            if (canalTexto != null && !canalTexto.isEmpty()) {
                ...
                if (!numeros.isEmpty()) {
                    System.out.println(GREEN + "    Canal MTX4 extraído: " + numeros + RESET);
                    return numeros;
                }
            }

            System.out.println(GREEN + "    Não conseguiu extrair canal MTX4, retornando N/A" + RESET);
            return "N/A";
    ...
    private String verificarPotenciaEcorrente(WebDriver driver, WebDriverWait wait) throws Exception {
        ...
        System.out.println(GREEN + "    Potência MTX4 extraída: " + potenciaValor + " W" + RESET);
        ...
        System.out.println(GREEN + "    Texto completo da corrente MTX4: " + textoCorrente + RESET);
        ...
        if (correnteValor == 0) {
            System.out.println(GREEN + "    Corrente MTX4 zero, retornando valor da potência" + RESET);
    ...
    private void salvarLogCanal(String canal, String canalAntes, String canalDepois, String potencia, String corrente, String offset, Map<String, Object> resultadoAjuste) {
        ...
        try (java.io.FileWriter writer = new java.io.FileWriter(filePath, true)) {
            ...
            System.out.println(GREEN + "  Log MTX4 salvo em: " + filePath + RESET);
        } catch (Exception e) {
    ...
    public ResponseEntity<Map<String, Object>> configurarOffsetMtx4(@RequestParam String offset) {
        ...
        System.out.println(GREEN + "=== CONFIGURANDO OFFSET PARA MTX4 ===" + RESET);
        ...
        try {
            ...
            // Navegar para offset
            System.out.println(GREEN + "Navegando para Internal4..." + RESET);
            WebElement internal4 = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("//label[@link='Internal4___']/input")));
            internal4.click();
            Thread.sleep(500);
            ...
            System.out.println(GREEN + "=== OFFSET MTX4 CONFIGURADO COM SUCESSO ===" + RESET);
    ...
    public ResponseEntity<Map<String, Object>> cancelarOffsetMtx4() {
        ...
        System.out.println(GREEN + "Solicitação de cancelamento de offset MTX4 recebida" + RESET);
